...
class NavigationDrawerWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isCalculatorSelected =
        currentRoute == AppRoutes.shippingCalculatorScreen ||
            currentRoute == AppRoutes.profitCalculatorScreen;
    return Drawer(
      child: Container(
        child: SafeArea(
          child: Column(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ExpansionTile(
                        initiallyExpanded: isCalculatorSelected,
                        ...
                        title: Text(
                          ...
                          style:
                            ...
                            fontWeight: isCalculatorSelected
                                ? FontWeight.w600
                                : FontWeight.w400,
                          ),
                        ),
                          ...
                          ListTile(
                            title: Text(
                              ...
                              style: AppTheme.lightTheme.textTheme.bodyMedium
                                  ?.copyWith(
                                color: currentRoute ==
                                        AppRoutes.shippingCalculatorScreen
                                    ? AppTheme.lightTheme.colorScheme.primary
                                    : AppTheme.lightTheme.colorScheme.onSurface,
                          ...
                          ListTile(
                            title: Text(
                              ...
                              style: AppTheme.lightTheme.textTheme.bodyMedium
                                  ?.copyWith(
                                color: currentRoute ==
                                        AppRoutes.profitCalculatorScreen
                                    ? AppTheme.lightTheme.colorScheme.primary
                                    : AppTheme.lightTheme.colorScheme.onSurface,
                                fontWeight: currentRoute ==
                                        AppRoutes.profitCalculatorScreen
  ...
  void _navigateToRoute(BuildContext context, String route, String title) {
    switch (route) {
      ...
      case '/shipping-calculator-screen':
      case '/profit-calculator-screen':
